...
//	Login form
    ...
    public String about(Model m) {
        ...
        return "about";  // Ensure you have an "about.html" template
    }
	 ...
	 @PostMapping("/submitContactForm")
	    public String submitContactForm(@RequestParam String name, 
	                                    ...
	                                    Model model) {
	        // Process the form data (you can log it or save it to the database)
	        System.out.println("Name: " + name);
	        System.out.println("Email: " + email);
	        System.out.println("Message: " + message);

	        // Optionally, add a success message to be shown after form submission
	        model.addAttribute("successMessage", "Your message has been sent!");

	        return "contact";  // Return the same page or a new page like "contactSuccess"
	    }
